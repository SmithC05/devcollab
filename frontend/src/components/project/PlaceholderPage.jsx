...
export default function PlaceholderPage({ title, subtitle }) {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-12 select-none">
      <div className="w-14 h-14 rounded-full bg-[#1c1c1e] border border-[var(--border-subtle)] flex items-center justify-center mb-5 text-2xl">
        🚧
      </div>
      <h1 className="text-lg font-semibold text-[var(--text-primary)] mb-2">{title}</h1>
